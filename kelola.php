        ...
        <input type="hidden" value="<?php echo $id_siswa; ?>" name="id_siswa">
            <div class="mb-3 row">
                ...
                <div class="col-sm-10">
                  ...
                  placeholder="Ex:12345" value="<?php echo $nisn; ?>">
                </div>
              </div>
              <div class="mb-3 row">
                ...
                <div class="col-sm-10">
                  ...
                  placeholder="Ex:Pablo Prances" value="<?php echo $nama_siswa; ?>">
                </div>
              </div>             
              <div class="mb-3 row">
                <label for="j_kel" class="col-sm-2 col-form-label">
                  Pilih Jenis Kelamin
                </label>
                <div class="col-sm-10">
                    <select required id="j_kel" name="jenis_kelamin" class="form-select">
